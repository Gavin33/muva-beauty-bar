    ...
    return (
      ...
      <div className="container">
        ...
        <div className="row row-content align-items-center">
          ...
          <div className="col">
            <a role="button" className="btn btn-link" href="tel:+19172747592">
              <i className="fa fa-phone"></i> 1-917-274-7592
            </a>
            <br />
            <a
              role="button"
            ...
            >
              <i className="fa fa-envelope-o"></i> muvabeautybar817@gmail.com
            </a>
          </div>
        </div>
